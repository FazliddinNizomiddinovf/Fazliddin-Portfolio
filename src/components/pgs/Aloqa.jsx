                ...
                <div className="grid md:grid-cols-2 gap-10 items-center mb-10">
                    <div className="bg-[#0f172a]/60 border border-white/10 backdrop-blur-xl p-8 rounded-2xl">
                        ...
                        <div className="mb-10">
                            ...
                            <h1 className="text-lg font-semibold">📞 +998 88 306 09 96</h1>
                        </div>
                        <div>
                            <h3 className="mb-5 font-bold text-3xl">Ijtimoiy tarmoqlar</h3>
                            <div>
                                <div className="flex gap-4">
                                    <a href="https://t.me/Fazliddin_iq" className="px-4 py-2 flex gap-3 items-center bg-blue-600 rounded-lg hover:bg-blue-700 transition"><svg className="w-8 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M320 72C183 72 72 183 72 320C72 457 183 568 320 568C457 568 568 457 568 320C568 183 457 72 320 72zM435 240.7C431.3 279.9 415.1 375.1 406.9 419C403.4 437.6 396.6 443.8 390 444.4C375.6 445.7 364.7 434.9 350.7 425.7C328.9 411.4 316.5 402.5 295.4 388.5C270.9 372.4 286.8 363.5 300.7 349C304.4 345.2 367.8 287.5 369 282.3C369.2 281.6 369.3 279.2 367.8 277.9C366.3 276.6 364.2 277.1 362.7 277.4C360.5 277.9 325.6 300.9 258.1 346.5C248.2 353.3 239.2 356.6 231.2 356.4C222.3 356.2 205.3 351.4 192.6 347.3C177.1 342.3 164.7 339.6 165.8 331C166.4 326.5 172.5 322 184.2 317.3C256.5 285.8 304.7 265 328.8 255C397.7 226.4 412 221.4 421.3 221.2C423.4 221.2 427.9 221.7 430.9 224.1C432.9 225.8 434.1 228.2 434.4 230.8C434.9 234 435 237.3 434.8 240.6z" /></svg>Telegram</a>
                    ...
                    <div className="bg-[#0f172a]/60 border border-white/10 backdrop-blur-xl p-7 rounded-2xl">
                        <span className="flex gap-5">
                            ...
                            <div className="flex gap-2 items-center w-full mb-4 px-4 py-3 rounded-xl bg-black/40 text-white border border-white/10 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/30 transition">
                                ...
                                <input maxLength={9} value={phone} onChange={(e) => { const onlyNumbers = e.target.value.replace(/\D/g, ""); if (onlyNumbers.length <= 9) { setPhone(onlyNumbers) } }} type="tel" inputMode="numeric" placeholder="Phone Number" className="bg-transparent outline-none" />
                            </div>
                        </span>
