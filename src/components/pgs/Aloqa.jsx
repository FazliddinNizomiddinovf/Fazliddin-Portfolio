                ...
                <div className="grid md:grid-cols-2 gap-10 items-center mb-10">
                    ...
                    <div className="bg-[#0f172a]/60 border border-white/10 backdrop-blur-xl p-7 rounded-2xl">
                        <span className="flex gap-5">
                            ...
                            <div className="flex gap-2 items-center w-full mb-4 px-3 py-2 rounded-xl bg-black/40 text-white border border-white/10 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/30 transition">
                                <h1>+998</h1>
